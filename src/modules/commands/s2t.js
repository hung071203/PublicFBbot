...
module.exports.run = async function (api, event, args, client) {
    ...
    let findUMN = await client.apis['database'].getBank(event.threadID, event.senderID)
    ...
    api.getThreadList(999, null, [], (err, arr) => {
        ...
        findUMN.money -= 100
        client.apis['database'].addBank(findUMN)
...
module.exports.handleReply = async function (api, event, client, hdr) {
    ...
    let checkMN = await client.apis['database'].getBank(event.threadID, event.senderID)
    ...
    checkMN.money -= 100
    client.apis['database'].addBank(checkMN)
